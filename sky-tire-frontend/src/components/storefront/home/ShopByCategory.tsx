...
const boltOn = collectionCards[3];
const accessories = collectionCards[4];
const wheels = collectionCards[5];
const blackwall = collectionCards[6];
...
function MobileCategoryRow({
  ...
  return (
    <Link
      href={href}
      className={`flex overflow-hidden rounded-lg bg-white shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] ${
        accent
          ? "border border-[#E6E7E9] border-l-[3px] border-l-[#C6A15B]"
          : "border border-[#E6E7E9]"
      }`}
    >
      <span
        className={`relative w-[145px] shrink-0 overflow-hidden ${
          tall ? "h-[178px]" : "h-[148px]"
        }`}
      >
        <Image
          src={image}
      ...
      <span className="flex flex-1 flex-col justify-center p-4">
        <span className="font-display text-[20px] uppercase leading-[1.25] text-[#0B0B0C]">
          {title}
        </span>
        <span className="mt-1 font-body text-[13px] leading-[1.25] text-[#6B6B6E]">
          {description}
        </span>
      </span>
    </Link>
...
export default function ShopByCategory() {
  ...
  return (
    <section className="bg-white">
      <div className="flex flex-col gap-2 px-6 pb-12 lg:hidden">
        <p className="font-body text-[11px] font-bold uppercase leading-[1.5] tracking-[0.1em] text-[#C6A15B]">
          Shop the Sky Tire Collection
        </p>
        <h2 className="font-display text-[26px] uppercase leading-[1.08] text-[#0B0B0C]">
          Build the Look.
        </h2>
        ...
        <div className="flex flex-col gap-4 py-6">
          ...
          <Link
            href={promo.href}
            className="relative flex h-[116px] overflow-hidden rounded-lg border border-[#C6A15B] bg-[#0B0B0C] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.2)]"
          >
            <span className="relative h-full w-[100px] shrink-0 overflow-hidden opacity-45">
              <Image
                src={promo.image}
                alt=""
                fill
            ...
            <span className="flex flex-1 flex-col justify-center px-4">
              <span className="font-body text-[11px] font-bold uppercase leading-[1.5] tracking-[0.16em] text-[#C6A15B]">
                Limited Time
              </span>
              <span className="mt-1 font-display text-[17px] uppercase leading-none text-white">
                Promotions
              </span>
              <span className="mt-1 font-body text-[13px] leading-[1.46] text-[#D1D1D4]">
                Deals • Packages • Clearance • Up to 67% Off
              </span>
            </span>
            <span className="flex w-[30px] shrink-0 items-center justify-start pr-5 text-[#C9CDD1]">
              <svg
                width="10"
                height="16"
                viewBox="0 0 10 16"
        ...
        <Link
          href="/#financing"
          className="inline-flex h-[44px] w-full items-center justify-center gap-3 rounded border border-[rgba(201,205,209,0.4)] bg-white"
        >
          <Icon name="financing" alt="" size={15} />
          <span className="font-body text-[13px] font-medium uppercase leading-[1.5] tracking-[0.004em] text-[#0B0B0C]">
            Financing Available
          </span>
        </Link>
      </div>
              ...
              >
                <div className="relative h-[138px] w-full shrink-0 overflow-hidden">
                  <Image
                    ...
                    fill
                    className={
                      card.title === "Accessories" ? "object-contain" : "object-cover"
                    }
                    sizes="(max-width: 1024px) 100vw, 290px"
                  />
                </div>
