  ...
  return (
    <section className="bg-white py-16 lg:py-24">
      <div className="mx-auto w-full max-w-[1280px] px-5 lg:px-6">
        ...
        <div className="mt-12 grid gap-10 pt-4 lg:mt-16 lg:grid-cols-3">
          {packages.map((item) => {
            ...
            return (
              <article
                key={item.title}
                className={`relative flex flex-col gap-4 bg-white px-8 pt-8 pb-[34px] ${
                  featured
              ...
              >
                ...
                <ul className="flex flex-col gap-3">
                  {item.items.map((line) => (
                    <li key={line} className="flex items-center">
                      ...
                      />
                      <span className="font-body text-[14px] leading-5 text-[#0B0B0C]">
                        {line}
                      </span>
                    </li>
                  ))}
                ...
                <p className="flex h-[60px] items-center">
                  ...
                  <span className="ml-1 font-body text-[14px] leading-5 text-[#9CA3AF]">
                    / set of 4
                  </span>
                </p>
