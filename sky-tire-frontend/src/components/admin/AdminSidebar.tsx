...
export default function AdminSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-[220px] flex-col border-r border-gray-100 bg-white">
      ...
      {/* User Info */}
      <div className="mx-3 mb-4 flex items-center gap-3 rounded-xl bg-[#e9edf5] px-3 py-2.5">
        <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#3B5998] text-sm font-semibold text-white">
          S
        </div>
        <div className="leading-tight">
          <p className="text-[13px] font-semibold text-[#1e2a4a]">SkySac</p>
